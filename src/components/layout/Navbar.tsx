  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6 md:px-12 flex items-center justify-between">
        ...
        {/* Desktop Navigation */}
        <nav className="hidden md:flex items-center gap-8 font-hebrew">
          {navLinks.map((link) => {
      ...
      {mobileMenuOpen && (
        <div className="md:hidden bg-[#09090b]/98 backdrop-blur-2xl border-b border-white/10 px-6 py-8 animate-fade-in font-hebrew text-right">
          <div className="flex flex-col gap-5">
            ...
            <Link
              to="/contact"
              className="flex items-center justify-center gap-2 text-sm font-bold bg-amber-400 text-black py-3.5 rounded-xl mt-4"
            >
              <span>התחלת פרויקט</span>
