...
export const VideoGalleryGrid: React.FC<VideoGalleryGridProps> = ({
  ...
  return (
    <div className="w-full">
      ...
      {(title || subtitle) && (
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-8 pb-4 border-b border-white/10 text-right font-hebrew">
          <div>
            {subtitle && (
          ...
          >
            ...
            >
              ...
              {project.video.duration && (
                <div className="absolute bottom-3 right-3 px-2.5 py-1 rounded bg-black/80 backdrop-blur-sm border border-white/10 text-[11px] font-mono text-amber-300 flex items-center gap-1">
            ...
            {/* Video Info Card */}
            <div className="p-5 flex-1 flex flex-col justify-between text-right font-hebrew">
              <div>
      ...
      {activeModalProject && (
        <div className="fixed inset-0 z-50 bg-black/95 backdrop-blur-2xl flex items-center justify-center p-4 md:p-10 animate-fade-in">
          ...
          <button
            ...
            className="absolute top-6 left-6 z-50 p-3 rounded-full bg-white/10 hover:bg-white/20 text-white transition-colors"
          >
            <X className="w-6 h-6" />
          </button>
          ...
          <div className="w-full max-w-5xl bg-[#121216] border border-white/10 rounded-2xl overflow-hidden shadow-2xl flex flex-col">
            ...
            <div className="p-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 bg-[#121216] text-right font-hebrew">
              <div>
